...
<div id="hs-application-sidebar" class="hs-overlay  [--auto-close:lg]
  ...
  <div class="relative flex flex-col h-full max-h-full">
    <div class="px-6 pt-4 ">
      <!-- Logo -->
      <a wire:navigate class="flex-none inline-block text-xl font-semibold text-blue-600 rounded-xl focus:outline-none focus:opacity-80" href="#" aria-label="E-commerce">
