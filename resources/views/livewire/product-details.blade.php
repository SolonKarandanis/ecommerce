<div>
    <div class="flex gap-5 p-20">
        <img src="{{asset('images/placeholder-image.jpg')}}" alt="product-images" class="rounded-t-lg object-cover w-[300px] h-[280px]">
        <div>
            <h2 class="p-1 text-2xl font-medium line-clamp-2">Name</h2>
            <h2 class="p-1 text-gray-500 line-clamp-4">Description</h2>
